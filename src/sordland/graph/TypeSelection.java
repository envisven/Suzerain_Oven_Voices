...
public final class TypeSelection {
    ...
    public Set<String> selectedFor(Collection<String> types){
        var selected=new LinkedHashSet<String>();for(String type:types)if(preferences.getOrDefault(type,!type.equals("News")&&!sordland.data.runtime.RuntimeDatabase.TYPES.containsValue(type)))selected.add(type);return Collections.unmodifiableSet(selected);
    }
